...
{
	if(!appMain.InitializeApp("Семинар 8.  2017-2018"))
		return 0;
	appMain.RegisterAppClass(hInstance);

	if(!appMain.CreateAppWindow("Семинар 8 2017-2018. Индексное рисование, Skybox, Мультитекстурирование. Репина Анастасия БПИ143"))
		return 0;
	appMain.ResetTimer();
